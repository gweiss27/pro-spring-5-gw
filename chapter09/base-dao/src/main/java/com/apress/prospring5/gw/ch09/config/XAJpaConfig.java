...
public class XAJpaConfig
{
    ...
    public DataSource dataSourceA()
    {
        try
        {
            ...
            logger.error("Populator DataSource A bean cannot be created!", e);
            return null;
        }
    }
    ...
    {
        Properties xaAProp = new Properties();
        xaAProp.put("databaseName", "MUSICDB_A");
        xaAProp.put("user", "prospring5_A");
        xaAProp.put("password", "prospring5_A");
        return xaAProp;
    }
    ...
    public DataSource dataSourceB()
    {
        ...
        {
            logger.error("Populator DataSource B bean cannot be created!", e);
            return null;
        }
    }
    ...
    {
        Properties xaAProp = new Properties();
        xaAProp.put("databaseName", "MUSICDB_B");
        xaAProp.put("user", "prospring5_B");
        xaAProp.put("password", "prospring5_B");
        return xaAProp;
    }
    ...
    public Properties hibernateProperties()
    {
        ...
        hibernateProp.put(JTA_PLATFORM, "com.atomikos.icatch.hibernate4.AtomikosPlatform");
    ...
    public EntityManagerFactory emfA()
    {
        ...
        factoryBean.setPackagesToScan("com.apress.prospring5.gw.ch09.entities");
