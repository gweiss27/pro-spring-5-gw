 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.apress.prospring5.gw.ch11.repos"})
...
public class DataServiceConfig
{
    ...
    public DataSource dataSource()
    {
        ...
        {
            logger.error("Embedded datasource could not be created: " + e);
            return null;
        }
    }
    ...
    public EntityManagerFactory entityManagerFactory()
    {
        ...
        factoryBean.setPackagesToScan("com.apress.prospring5.gw.ch11.entities");
